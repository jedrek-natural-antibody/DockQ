...
def calc_DockQ(model,native,use_CA_only=False,capri_peptide=False):
    ...
    if dockq_path is None:
        exec_path = os.getcwd()
    else:
        exec_path = dockq_path
...
#def main():
def main(xmodel = None, xnative = None, xdockq_path = None, xnative_chain1 = None):
    global dockq_path
    dockq_path = xdockq_path
...
#    native=sys.argv[2]
    ...
    if xnative_chain1 is None:
    	xnative_chain1 = args.native_chain1
